<%-- 
    ...
    Created on : 04/12/2010, 05:28:45 PM
    Author     : MAFER
--%>
...
<html>
    <head>
       ...
       <script type="text/javascript" src="./JavaScript/json.js"></script>
            ...
            <script type="text/javascript" src="./JavaScript/deleteCliente.js"></script>
		...
		<p>
			<input type="button" name="submit" value="Buscar" onclick="findcliente()"/>
			<input type="button" name="submit" value="Eliminar" onclick="deleteCliente()"/>
		</p>
