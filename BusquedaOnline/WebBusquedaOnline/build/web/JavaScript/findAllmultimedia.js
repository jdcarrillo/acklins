...

{
    ...
    if(ajaxObj)
    {
        ...
        if (ajaxObj.readyState == 4 || ajaxObj.readyState == 0)
        {
            ...
            var URL = "http://buscaonline.dyndns.org:8080/Busqueda/resources/Multimedia/multimedias/";
    ...
    if (ajaxObj.readyState == 4)
    {
        ...
        if (ajaxObj.status == 200)
        {
           ...
           //window.alert("No records found");
            ...
            var row, cell, x;
             maxRows=myObject.multimedias[0].RowNumber;
            ...
            var nrRows=Number(maxRows)+1;
                ...
                row=document.createElement('tr');
                   ...
                   row=document.createElement('tr');
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.multimedias[i].IDMULTIMEDIA;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.multimedias[i].TIPOCONTENIDO;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.multimedias[i].DESCRIPCION;
                    cell.innerHTML = x;
                    row.appendChild(cell);
