...

{
...

    {
...

        {
            ...
            var URL = "http://buscaonline.dyndns.org:8080/Busqueda/resources/catalogo/catalogo/" + inputObject.value + "/json/";
...

{
...

    {
...

        {
            ...
            var x = myObject.catalogo.IDCATALOGO;
            if(x!=null)
            {
            ...
            var row, cell, myObject, x;
                row=document.createElement('tr');
                    ...
                    cell.setAttribute("style", "padding-left:5px;");
                    myObject = JSON.parse(textResponse);
                    x = myObject.catalogo.IDCATALOGO;
                    cell.innerHTML = x;
                    row.appendChild(cell);
