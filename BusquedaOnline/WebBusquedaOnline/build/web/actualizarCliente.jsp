<%-- 
    ...
    Created on : 04/12/2010, 04:49:02 PM
    Author     : MAFER
--%>
...
<html>
    <head>
       ...
       <script type="text/javascript" src="./JavaScript/findToUpdatecliente.js"></script>
		...
		<p>
			<input type="button" name="submit" value="Buscar" onclick="findToUpdatecliente()"/>
                        <input type="submit" value="Update" onclick="updatecliente()"/>
		</p>
