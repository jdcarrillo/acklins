...

{
    ...
    if(ajaxObj)
    {
        ...
        if (ajaxObj.readyState == 4 || ajaxObj.readyState == 0)
        {
            ...
            var URL = "http://192.168.0.12:8080/Busqueda/resources/Proveedor/proveedores/";
    ...
    if (ajaxObj.readyState == 4)
    {
        ...
        if (ajaxObj.status == 200)
        {
           ...
           //window.alert("No records found");
            ...
            var row, cell, x;
             maxRows=myObject.proveedores[0].RowNumber;
            ...
            var nrRows=Number(maxRows)+1;
                ...
                row=document.createElement('tr');
                   ...
                   row=document.createElement('tr');
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].IDPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].NOMBREPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].DIRECCIONPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].CIUDADPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].TELEFONOPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell=document.createElement('td');
                    cell.setAttribute("style", "padding-left:5px;");
                    x = myObject.proveedores[i].EMAILPROVEEDOR;
                    cell.innerHTML = x;
                    row.appendChild(cell);
