...

        {
            ...
            var row, cell, myObject, x;
                row=document.createElement('tr');
                    ...
                    cell.setAttribute("style", "padding-left:5px;");
                    myObject = JSON.parse(textResponse);
                    x = myObject.producto.IDPRODUCTO;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell.setAttribute("style", "padding-left:5px;");
                    myObject = JSON.parse(textResponse);
                    x = myObject.producto.NOMBREPRODUCTO;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell.setAttribute("style", "padding-left:5px;");
                    myObject = JSON.parse(textResponse);
                    x = myObject.producto.PRECIOSINIVA;
                    cell.innerHTML = x;
                    row.appendChild(cell);
                    ...
                    cell.setAttribute("style", "padding-left:5px;");
                    myObject = JSON.parse(textResponse);
                    x = myObject.producto.PRECIOCONIVA;
                    cell.innerHTML = x;
                    row.appendChild(cell);
