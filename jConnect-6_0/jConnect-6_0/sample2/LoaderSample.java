...
/**
 * LoaderSample class  may be used to demonstrate the use of the Dynamic
 * Class Loader feature of jConnect.  This demo requires:<br>
 ...
 *
 * <P>LoaderSample may be invoked with the parameters:<br>
 * -U username<br>
 * -P password<br>
 * -D debuglibraries<br>
 * -S server<p>
 ...
 *
 * Example:<p>
 * java sample2.SybSample LoaderSample -U sa -P -u jdbc:sybase:Tds:dbname:1111/dbname -S jdbc:sybase:Tds:dbname:1111/dbname<br>
 *
 *  @see Sample
 */
public class LoaderSample extends Sample
{
